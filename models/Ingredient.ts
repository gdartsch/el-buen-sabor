    ...
    unidadMedida: [
      {
        ...
        message:
          'La unidad de medida debe ser una de las siguientes: Kg, Lt, Gr, Unidad, Otro',
        default: 'bebida',
      },
    ],
    categoria: [
      {
        ...
        message:
          'La categoria debe ser una de las siguientes: bebida, lacteos, carne, panificados, vegetales, condimentos, otro',
        default: 'bebida',
      },
    ],
